...
import com.simon816.minecraft.tabchat.tabs.TextFileTab;
import com.simon816.minecraft.tabchat.tabs.canvas.BlockRenderContext;
            ...
            CanvasTab canvas = new CanvasTab(Text.of("Sine Wave Demo")) {
                ...
                public void onFocus() {
                    ...
                    this.task = Sponge.getScheduler().createTaskBuilder().execute(() -> {
                        ...
                        view.update();
                    }).intervalTicks(2).submit(TabbedChat.instance());
                }
